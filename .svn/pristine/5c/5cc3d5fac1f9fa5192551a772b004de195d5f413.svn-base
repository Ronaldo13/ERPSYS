...
<body>
	...
	<form action="ErpsysBasicInformation/addEBIk" method="get">
		<table align="center" class="table" style="width: 50%">
			...
			<tr>
				<td>员工密码</td>
				<td><input style="width: 100%;" type="text" name="accountPwd"
					value="${erpsysBasicInformation.accountPwd}" /></td>
			</tr>
			<tr>
				<td>员工姓名</td>
			...
			<tr>
				<td>职位名称</td>
				<td><select name="accountJobId" style="width: 100%; height: 30px;">
            ...
            <tr>
				<td>帐号状态</td>
				<td><select name="accountStatus" style="width: 100%; height: 30px;">
			...
			<tr>
				<td colspan="2" align="center"><input class="btn btn-success"
					type="submit" value="提交" /> <a class="btn btn-warning"
