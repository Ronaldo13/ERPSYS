...
public interface WareHouseService {
	...
	void AddWareFromOrder(HttpServletRequest request, WareHouseModel wareHouseModel);

	void updateProductNumberByProductionWarehouseId(Integer productionWarehouseId, int number);

	void AddWareFromProduct(WareHouseModel wareHouseModel);
