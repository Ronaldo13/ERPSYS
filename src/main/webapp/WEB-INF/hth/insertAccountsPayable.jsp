	...
	<div
		...
		<form class="form-horizontal">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<select id="alreadyPaid" class="form-control NotNull">
						<option value="1">已出账</option>
						<option value="0" selected = "selected">未出账</option>
					</select>
				</div>
			</div>
			<div class="form-group">
				...
				<div class="col-sm-10">
					...
					<div class="input-append date" id="datetimepicker2"
						...
						<input type="text" class="form-control" value=""
							id="payTimeString" readonly> <span class="add-on"><i
	...
	<script type="text/javascript">
		...
		function submitInsert() {
			if (hasNotNull() == true){
				$
						.ajax({
							url : "insertAccountsPayableSubmit",
							type : "post",
							dataType : "text",
							...
							success : function(result) {
								...
								if (result == "SUCCESS") {
									...
									parent.window.location.href = "financialManagementAccountsPayable?pageEnd=yes"
