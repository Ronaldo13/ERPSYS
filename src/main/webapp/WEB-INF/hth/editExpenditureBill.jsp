	...
	<div
		...
		<form class="form-horizontal">
			<div class="form-group">
				<label class="col-sm-2 control-label">出账账单编号<span style="color:red;"> *</span></label>
				<div class="col-sm-10">
					<input type="text" class="form-control notNull" placeholder="出账账单编号"
						id="expenditureId" value="${expenditure.expenditureId }" disabled>
				</div>
			</div>
			<div class="form-group">
				<label class="col-sm-2 control-label">出账金额<span style="color:red;"> *</span></label>
				<div class="col-sm-10">
			...
			<div class="form-group">
				<label class="col-sm-2 control-label">出账原因<span style="color:red;"> *</span></label>
				<div class="col-sm-10">
					<input type="text" class="form-control notNull" placeholder="出账原因"
						id="expenditureReason" value="${expenditure.expenditureReason }">
				</div>
			</div>
			<div class="form-group">
				<label for="inputPassword3" class="col-sm-2 control-label">出账时间<span style="color:red;"> *</span></label>
				<div class="col-sm-10">
					<input type="text" class="form-control notNull" placeholder="出账时间"
						id="expenditureTimeString"
						value="${expenditure.expenditureTimeString }" disabled>
				</div>
			</div>
			<div class="form-group">
				...
				$
						.ajax({
							...
							success : function(result) {
								// 					alert(result);
								if (result == "SUCCESS") {
									var expenditureId = $("#expenditureId")
											.val();
									var expenditureMoney = $(
											"#expenditureMoney").val();
									var expenditureReason = $(
											"#expenditureReason").val();
									// 						alert("修改成功！")
									//当你在iframe页面关闭自身时
									parent
											.changeTable(expenditureId,
													expenditureMoney,
													expenditureReason);
