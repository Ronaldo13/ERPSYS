...
<body>
	...
	<div class="container">
		<div class="logo">
			<a href="MineCon/index">零件加工厂ERP管理系统</a>
		</div>
		<div class="left_open">
		...
		<ul class="layui-nav right">
			...
			<li class="layui-nav-item to-index"><a href="MineCon/index">首页</a></li>
		</ul>
		...
		<div id="side-nav">
			<ul id="nav">
				...
				<li><a href="javascript:;"> <img
					...
					<ul class="sub-menu">
						<li><a _href="<%=basePath%>financialManagementRecordBill"> <i
								class="iconfont">&#xe6a7;</i> <cite>入账账单管理</cite>
						</a></li>
						<li><a _href="<%=basePath%>financialManagementExpenditureBill"> <i
								class="iconfont">&#xe6a7;</i> <cite>出账账单管理</cite>
						</a></li>
						<li><a _href="<%=basePath%>financialManagementAccountsPayable"> <i
								class="iconfont">&#xe6a7;</i> <cite>应出账务管理</cite>
						</a></li>
						<li><a _href="<%=basePath%>financialManagementAccountsReceivable"> <i
								class="iconfont">&#xe6a7;</i> <cite>应收账务管理</cite>
						</a></li>
						<li><a _href="<%=basePath%>financialManagementLog"> <i
				...
				<li><a href="javascript:;"> <img
					...
					<ul class="sub-menu">
						...
						<li><a _href="<%=basePath%>select/doProductSreach"> <i
								class="iconfont">&#xe6a7;</i> <cite>生产管理</cite>
						</a></li>
	...
	<!-- 底部开始 -->
	<div class="footer">
		<div class="copyright">POWER BY JAYNES</div>
	</div>
	<!-- 底部结束 -->
</body>
<script type="text/javascript">
